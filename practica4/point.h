...
/**
 * @brief Gets the visited of a given point.
 *
 * @param p Point pointer
 *
 * @return Returns visited or FALSE in case of error 
 */
Bool point_getVisited (const Point *p); /* DFS (P2)*/

/**
 * @brief Modifies the visited of a given point.
 *
 * @param p Point pointer
 * @param bol New state of visited, must be a valid Bool
 *
 * @return Returns OK or ERROR in case of error 
 */
